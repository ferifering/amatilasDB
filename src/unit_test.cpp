...
TEST(LRUReplacerTest, SampleTest) {
    std::cout<<"LRUReplacerTest 1"<<std::endl;
    ...
    lru_replacer.victim(&value);
    EXPECT_EQ(4, value);
    std::cout<<"LRUReplacerTest end"<<std::endl;
}
...
TEST_F(BufferPoolManagerTest, SampleTest) {
    ...
    std::cout<<"BufferPoolManager 1"<<std::endl;
...
TEST(StorageTest, SimpleTest) {
    ...
    std::cout<<"StorageTest start"<<std::endl;
    ...
    std::cout<<"StorageTest 1"<<std::endl;
    ...
    std::cout<<"StorageTest 2"<<std::endl;
    check_cache_all();
    std::cout<<"StorageTest 3"<<std::endl;
    ...
    check_disk_all();
    std::cout<<"StorageTest 4"<<std::endl;
    ...
    check_cache_all();
    std::cout<<"StorageTest 5"<<std::endl;
    for (auto &entry : fd2name) {
        int fd = entry.first;
        buffer_pool_manager->flush_all_pages(fd);
        for (int page_no = 0; page_no < MAX_PAGES; page_no++) {
    ...
    check_disk_all();
    std::cout<<"StorageTest 6"<<std::endl;
...
TEST(RecordManagerTest, SimpleTest) {
    srand((unsigned)time(nullptr));
    std::cout<<"RecordManagerTest s"<<std::endl;
    // 创建RmManager类的对象rm_manager
    auto disk_manager = std::make_unique<DiskManager>();
    std::cout<<"RecordManagerTest 1"<<std::endl;
    auto buffer_pool_manager = std::make_unique<BufferPoolManager>(BUFFER_POOL_SIZE, disk_manager.get());
    auto rm_manager = std::make_unique<RmManager>(disk_manager.get(), buffer_pool_manager.get());
    std::cout<<"RecordManagerTest 2"<<std::endl;
    std::unordered_map<Rid, std::string, rid_hash_t, rid_equal_t> mock;
    std::cout<<"RecordManagerTest 3"<<std::endl;
    ...
    // test pages
    std::cout<<"RecordManagerTest 4"<<std::endl;
    rm_manager->create_file(filename, record_size);
    ...
    size_t upd_cnt = 0;
    size_t del_cnt = 0;
    std::cout<<"RecordManagerTest 5"<<std::endl;
